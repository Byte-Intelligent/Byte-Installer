...
@section('content')
    <div class="p-sm-25 p-15 bd-one bd-t-zero bd-c-stroke bd-ra-8 bd-tl-ra-0 bd-tr-ra-0 bg-white mb-25">
        <h4 class="bg-body-bg flex-row-reverse fs-6 my-1 p-10 rounded-2 section-title text-black">
        ...
        <form action="{{ route('BiInstaller::check-validation') }}" method="post">
            @csrf
            ...
            <button class="bg-para-text w-100 py-10 rounded-3 text-bg-success fw-1000 border-0">Next</button>
        </form>
    </div>
@endsection
